...
from dscrapy.common.spider.base_spider import BaseSpider
...
class JDSpider(BaseSpider):
    ...
    custom_settings = {
        'ITEM_PIPELINES':{'dscrapy.pipelines.shop.jd_pipelines.DataBasePipeline': 300},
        'EXTENSIONS':{'dscrapy.extensions.spider_closed_extension.SpiderClosedExtension': 300},
        'MYEXT_ENABLED':True,
    }
